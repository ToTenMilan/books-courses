...
# workd as kind of microservice Controller
...
class RecommendationApi:
    ...
    # I prefer 'GET /user/<int:user_id>/recommendations'
    ...
    # I prefer 'GET /label/<string:label>/recommendations'
